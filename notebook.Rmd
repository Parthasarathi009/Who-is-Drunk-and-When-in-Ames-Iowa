...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_start_time: 1.698 0.089 49.611 0.004 0
...
<table>
<thead><tr><th scope=col>location</th><th scope=col>n</th></tr></thead>
<tbody>
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 1.761 0.089 49.674 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
<table>
<thead><tr><th scope=col>hour</th><th scope=col>n</th></tr></thead>
<tbody>
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 2.484 0.104 50.416 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 3.155 0.112 51.095 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
<table>
<thead><tr><th scope=col>year</th><th scope=col>month</th><th scope=col>day</th><th scope=col>hour</th><th scope=col>location</th><th scope=col>gender</th><th scope=col>Res1</th><th scope=col>Res2</th><th scope=col>meanRes</th></tr></thead>
<tbody>
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 3.669 0.112 51.607 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 3.733 0.116 51.674 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
<table>
<thead><tr><th scope=col>year</th><th scope=col>month</th><th scope=col>day</th><th scope=col>hour</th><th scope=col>location</th><th scope=col>gender</th><th scope=col>Res1</th><th scope=col>Res2</th><th scope=col>date</th></tr></thead>
<tbody>
	<tr><td>2017      </td><td>12        </td><td>17        </td><td>1         </td><td>Ames PD   </td><td>M         </td><td>0.046     </td><td>0.046     </td><td>2017-12-17</td></tr>
	<tr><td>2017      </td><td>12        </td><td>14        </td><td>3         </td><td>ISU PD    </td><td>F         </td><td>0.121     </td><td>0.120     </td><td>2017-12-14</td></tr>
</tbody>
</table>
...
<table>
<thead><tr><th scope=col>year</th><th scope=col>month</th><th scope=col>day</th><th scope=col>hour</th><th scope=col>location</th><th scope=col>gender</th><th scope=col>Res1</th><th scope=col>Res2</th><th scope=col>date</th><th scope=col>week</th></tr></thead>
<tbody>
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 3.935 0.116 51.876 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
<table>
<thead><tr><th scope=col>year</th><th scope=col>week</th><th scope=col>n</th></tr></thead>
<tbody>
	<tr><td>2013</td><td>1   </td><td> 6  </td></tr>
	<tr><td>2013</td><td>2   </td><td>12  </td></tr>
</tbody>
</table>
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 4.437 0.124 52.386 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 5.189 0.128 53.141 0.004 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
